...
- (void)customPageView {
    ...
    HQAroundViewController *ctrl1 = [[HQAroundViewController alloc] init];
    ctrl1.navigationController = self.navi;
    HQAnalyseViewController *ctrl2 = [[HQAnalyseViewController alloc] init];
    ctrl2.navigationController = self.navi;
    SDTimeLineTableViewController *ctrl3 = [[SDTimeLineTableViewController alloc] init];
    ctrl3.navigationController = self.navi;
    [ctrl1 setValue:self.navi forKey:@"navigationController"];
    ...
    self.pageViewCtrl.view.frame = CGRectMake(0, 0, self.contentView.frame.size.width, self.contentView.frame.size.height);
}
